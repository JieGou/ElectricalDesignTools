...
{
    public static string Rule14_100_B { get; set; } = "Maximum conductor length for smaller tap conductors is 3m" + "\n\n" +
    ...
    public static string Rule14_100_C { get; set; } = "Maximum conductor length for tap conductors where the smaller conductoris 7.5m" + "\n\n" +
                                                      "All other items of Rule 14-100(b) must also be considered.";
    public static string Rule14_100_C_Caption { get; set; } = "Cable length violation - CEC Rule 14-100(c).";

    public static string Rule14_100_D { get; set; } = "Maximum conductor length for equipment fed from tranformers rated over 750V without secondary protection is 7.5 meters. " + "\n\n" +
