...
namespace EDTLibrary.Tests.Models.Loads
{
    public class LoadToAddValidatorTest
    {
        ...
        [InlineData("MTR-12", "MOTOR", "MCC-02", "2000", "A", "600")]
        [InlineData("MTR-13", "MOTOR", "MTR-11", "2000", "HP", "600")]
        public void IsValid_False(string tag, string type, string fedFrom, string size, string unit, string voltage){
            ...
            //Act
            LoadToAddValidator LoadToAdd = new LoadToAddValidator(_listManager, selectedDteq);
            LoadToAdd.Tag = tag;
            LoadToAdd.Type = type;
